/** Excalidraw official logo path (from excalidraw/excalidraw ExcalLogo). */
const EXCALIDRAW_LOGO_PATH =
...
export function FolderToolbarIcon() {
  return (
    <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
      <path
...
/** Viewfinder corners — reveal / locate active file in the tree. */
export function LocateActiveFileIcon() {
  return (
    <svg viewBox="0 0 24 24" focusable="false" aria-hidden="true">
      <path
