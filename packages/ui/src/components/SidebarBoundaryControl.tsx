...
export function SidebarBoundaryControl({
  collapsed,
  width,
  onWidthChange,
  onToggleCollapsed,
}: SidebarBoundaryControlProps) {
  const t = useT();
  ...
  const onResizePointerMove = (event: ReactPointerEvent<HTMLDivElement>) => {
    ...
    onWidthChange(clampSidebarWidth(dragRef.current.startWidth + delta));
  };
